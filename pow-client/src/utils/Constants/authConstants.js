export const IDENTITY_CONFIG = {
  ...
  redirect_uri: process.env.REACT_APP_REDIRECT_URL = "http://localhost:3000/signin-oidc",
  silent_redirect_uri: process.env.REACT_APP_SILENT_REDIRECT_URL = "http://localhost:3000/signout-callback-oidc",
  post_logout_redirect_uri: process.env.REACT_APP_LOGOFF_REDIRECT_URL = "http://localhost:3000/signout-callback-oidc",
